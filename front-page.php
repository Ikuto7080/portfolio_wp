                    ...
                    <ul class="features-list">
                        <li class="features-item wow animate__animated animate__fadeIn" data-wow-offset="100" >
                            <div class="text">
                                ...
                                <!-- ボタンの作成 -->
                                <div class="foatures-link cmn-link"><a href="#">お部屋の詳細</a></div>
                            </div>
                            <!-- 画像を挿入 -->
                        ...
                        <li class="features-item wow animate__animated animate__fadeIn" data-wow-offset="100">
                            <div class="text">
                                ...
                                <div class="foatures-link cmn-link"><a href="#">コース料理の詳細</a></div>
                            </div>
                        ...
                        <li class="features-item wow animate__animated animate__fadeIn" data-wow-offset="100">
                            <div class="text">
                                ...
                                <p class="desc">京の極楽の最上階にある「スパ・ゴクラク」。湧き上がる天然温泉の 恵みで細胞内のバランスを整え新陳代謝を向上させてくれます。大い なる自然を感じながらリラックスすれば、身体の奥から元気が蘇って くるでしょう。京都らしい和のテイストを取り入れた五感を癒すペン トハウススパ。心と体のリフレッシュに最適です。</p>
                                <div class="foatures-link cmn-link"><a href="#">温泉の詳細</a></div>
                            </div>
                ...
                <div class="blog-cont">
                    <dl class="blog-list">
                        ...
                        <?php while ($the_query->have_posts()): $the_query->the_post(); ?>
                            <div class="row">
                                <dt><?php the_title(); ?></dt>
                                <dd><?php echo CFS()->get('except'); ?></dd>
                            </div>
                        <?php endwhile; endif; ?>
                    </dl>
                    <div class="blog-link cmn-link"><a href="<?php bloginfo("url");?>/works">もっと見る</a></div>
                </div>
            </div>
        </section>
